...
public class Kelas {
    ...
    public int getHasilJumlahKondisi() {
        return HasilJumlahKondisi;
    }

    public void setHasilJumlahKondisi(int HasilJumlahKondisi) {
        this.HasilJumlahKondisi = HasilJumlahKondisi;
    }
